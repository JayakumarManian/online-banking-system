...
<body>
    <div class="nav-wrapper">
        <div class="topnav" id="theTopNav">
            ...
            <a id="logout" href="/net-banking/logout_action.php" onclick="return confirm('Are you sure?')">Logout</a>
            <a id="profile" href="/net-banking/customer_profile.php">My Profile</a>
        </div>
    </div>
