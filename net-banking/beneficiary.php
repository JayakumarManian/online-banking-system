    ...
    <div class="search-bar-wrapper">
        <div class="search-bar" id="the-search-bar">
            <div class="flex-item-search-bar" id="fi-search-bar">
                <a class="add-button" href="/net-banking/add_beneficiary.php">Add</a>
                        ...
                        <div class="flex-item-1">
                            <div class="dropdown">
                              ...
                              <div id="dropdown<?php echo $i ?>" class="dropdown-content">
                                ...
                                <a href="/net-banking/send_funds.php?cust_id=<?php echo $row1["cust_id"] ?>">Send</a>
                                <a href="/net-banking/delete_beneficiary.php?cust_id=<?php echo $row1["cust_id"] ?>"
            ...
            if ($back_button) { ?>
                <div class="flex-container-bb">
                    <div class="back_button">
                        <a href="/net-banking/beneficiary.php" class="button">Go Back</a>
                    </div>
                </div>
            <?php }
            $conn->close(); ?>
