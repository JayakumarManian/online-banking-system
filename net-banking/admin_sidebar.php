...
<body>
    <div class="sidenav" id="theSideNav">
        ...
        <a href="/net-banking/admin_home.php">Home</a>
        <a id="label">My Customers</a>
        <a href="/net-banking/customer_add.php">Add Customer</a>
        <a href="/net-banking/manage_customers.php">Manage Customers</a>
        <a href="#h">Customer Griveances</a>
        <a id="label">Website Management</a>
        <a href="/net-banking/post_news.php">Post News</a>
    </div>
