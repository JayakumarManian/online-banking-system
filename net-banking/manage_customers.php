                    ...
                    <div class="flex-item-1">
                        <div class="dropdown">
                          ...
                          <div id="dropdown<?php echo $i ?>" class="dropdown-content">
                            ...
                            <a href="/net-banking/edit_customer.php?cust_id=<?php echo $row["cust_id"] ?>">View / Edit</a>
                            <a href="/net-banking/transactions.php?cust_id=<?php echo $row["cust_id"] ?>">Transactions</a>
                            <a href="/net-banking/delete_customer.php?cust_id=<?php echo $row["cust_id"] ?>"
